...
![First segment](../img/first-selection.png){: style="width: 100%;margin:0 auto;display:block;"}
...
![All selected](../img/all-selected.png){: style="width: 100%;margin:0 auto;display:block;"}
